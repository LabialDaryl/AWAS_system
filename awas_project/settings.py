...
# Database
# Supports PostgreSQL (default) or SQLite via DB_ENGINE in .env
...
if DB_ENGINE == 'sqlite3':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='awas_db'),
...
SESSION_COOKIE_AGE = config('SESSION_COOKIE_AGE', default=43200, cast=int)  # 12 hours
